...
export default async function KeysPage() {
  ...
  return (
    <Layout>
      <div className="mb-7">
        <h1 className="text-2xl font-bold text-slate-900">Keys & Assignments</h1>
        <p className="mt-1 text-sm text-slate-500">Manage the three global keys, their sub goals, and assigned project work.</p>
      </div>
